...
int main (int argc, char *argv[]) {
    ...
    /* Copier le nom d'utilisateur dans la variable pseudo*/
          ...
          ** (pseudo_S2C et entree standard)*/
          ...
          default:
              ...
              if ((FD_ISSET(STDIN_FILENO,&readfds))){
                  ...
                  char finserveur[TAILLE_MSG];
                  sprintf(finserveur,"Fin serveur ...");
                  if (!strcmp(buf,finserveur)){
                    /* Fermeture du serveur*/
                    exit(EXIT_SUCCESS);
                  } else {
                    strcpy(discussion[curseur%NB_LIGNES] ,buf);
                    afficher(curseur++);
                  }
              }
    ...
    /* Attendre le traitement de la part du serveur*/
    sleep(1);
